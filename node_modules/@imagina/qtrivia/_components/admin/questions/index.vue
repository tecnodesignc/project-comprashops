<template>
  <div id="componentCrudIndex" class="row q-col-gutter-sm">
    
    
    <div class="col-12 col-md-7">

      <q-banner rounded class="bg-primary text-white text-uppercase text-bold q-mb-sm">
        <template v-slot:avatar>
          <q-icon name="fas fa-question-circle" color="white" />
        </template>
         {{$trp('qtrivia.layout.question')}}
      </q-banner>
            ...
            <q-td slot="body-cell-actions" slot-scope="props" :props="props">
              ...
              <q-btn color="deep-orange" icon="fas fa-boxes" size="xs" class="q-ml-xs q-px-sm"
               @click="searchAnswers(props.row)">
                <q-tooltip :delay="300">{{$trp('qtrivia.layout.answer')}}</q-tooltip>
              </q-btn>
     ...
     <div class="col-12 col-md-5">
      ...
      <q-banner rounded class="bg-deep-orange text-white text-uppercase text-bold q-mb-sm">
        <template v-slot:avatar>
          <q-icon name="fas fa-boxes" color="white" />
        </template>
         {{$trp('qtrivia.layout.answer')}}
      </q-banner>
     
      <crudAnswers :crud-data="import('@imagina/qtrivia/_crud/answers')"
...
<script>
  import crudAnswers  from '@imagina/qtrivia/_components/admin/answers/crud'
  export default {
    props: {
