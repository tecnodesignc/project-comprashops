  ...
  export default {
    ...
    data() {
       return {
        ...
        configName: 'apiRoutes.qtrivia.questions',
        itemId: false,
        locale: {
          fields: {
            id: '',
        ...
        setTimeout(() => {
          ...
          switch (action) {
            case 1://redirect to index products
              this.$router.push({name: 'qtrivia.admin.trivias.index'})
              break;
      ...
      updateItem() {
        ...
        if (!this.$v.$error) {
          ...
          this.$crud.update(this.configName, this.itemId, this.locale.form).then(response => {
            ...
            this.$router.push({name: 'qtrivia.admin.trivias.index'})//Redirect to index
            this.loading.page = false
          }).catch(error => {
            this.loading.page = false
